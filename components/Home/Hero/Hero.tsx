...
const Hero = () => {
  return (
    <main className="relative pt-24  mx-auto max-w-[1300px] px-4 sm:px-6 lg:px-8 flex items-center min-h-screen text-lightie">
      {/*Particles code*/}
        ...
        <div className="text-left">
          <motion.div variants={fadeInUp}>
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className=" pulse-txt text-sm sm:text-lg text-teal-400">
                Hey There!
              </span>
            </div>
          </motion.div>
          ...
          <p className=" text-gray-400 text-lg max-w-lg">
            Specializing in front-end and back-end development, I create modern,
            responsive websites and web applications that deliver exceptional
          ...
          <div className="flex items-center self-start mt-2">
            <Link
              ...
              className="flex items-center bg-teal-400 text-slate-900 p-2.5 px-6 rounded-xl text-base font-semibold hover:bg-purple-400
                hover:text-dark  border-solid border-transparent hover:shadow-lg hover:shadow-teal-400/50  hover:border-dark border-2 transition-all duration-300"
              download={true}
            >
